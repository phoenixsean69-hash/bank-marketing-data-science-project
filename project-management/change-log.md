...
| C003 | 10 September 2026 | Decided not to rely on accuracy as the main evaluation metric | The target is imbalanced: 88.3% `no` and 11.7% `yes` | Recall, precision, F1-score and ROC-AUC will also be evaluated | Approved |
